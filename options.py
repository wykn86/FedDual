...
def args_parser():
    ...
    parser.add_argument('--root_path', type=str, default='/datasets/training_data', help='dataset root dir')
    parser.add_argument('--csv_file_train', type=str, default='datasets/1338/training.csv', help='training set csv file')
    parser.add_argument('--csv_file_val', type=str, default='/datasets/1338/validation.csv', help='validation set csv file')
    parser.add_argument('--csv_file_test', type=str, default='/datasets/1338/testing.csv', help='testing set csv file')
    ...
    parser.add_argument('--rounds', type=int,  default=201, help='local epoch')
