...
import random
from tsne.tsne import read_data_tsne

args = args_parser()
checkpoint_path = os.path.join('models/', 'epoch_0.pth')
...
if __name__ == "__main__":
    ...
    for thresh in thre:
        ...
        AUROCs, Accus, Senss, Specs, _, f1 = epochVal_metrics_test(model, test_dataloader, thresh=thresh)
