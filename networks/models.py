...
class DenseNet121(nn.Module):
    ...
    def __init__(self, out_size, mode, drop_rate=0):
        ...
        self.projector_head = nn.Linear(num_ftrs, 128)
        nn.init.constant_(self.projector_head.bias, 1)

        self.feature_layer = nn.Linear(num_ftrs, 128)
    ...
    def forward(self, x):
        ...
        projector = self.projector_head(out)
        ...
        return self.activations, feature, projector, out
